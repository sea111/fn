        ...
        var t = function() {
                ...
                this.I_Login = function(e, t, s, n, r, o) {
                    ...
                    this.I_StartRealPlay = function(e, t) {
                        ...
                        if (I.extend(h, t), -1 != n) {
							...
							console.log(C)
							console.log("C == R",C == R)
							console.log("f.oStreamCapa.bSupportShttpPlay",f.oStreamCapa.bSupportShttpPlay)
							console.log(C == R && f.oStreamCapa.bSupportShttpPlay)
                            if (C == R && f.oStreamCapa.bSupportShttpPlay ? (Z("SHTTP RealPlay"), o = f.oProtocolInc.CGI.startShttpRealPlay, i = "http://", d = h.iStreamType - 1, u = h.iChannelID <= f.iAnalogChannelNum ? h.iChannelID: f.oStreamCapa.iIpChanBase + parseInt(h.iChannelID, 10) - f.iAnalogChannelNum - 1, P = !0, W(h.iPort) ? "https://" == f.szHttpProtocol ? ( - 1 == f.iHttpPort && (f.iHttpPort = B(f).iHttpPort), a = f.iHttpPort) : a = f.iCGIPort: (f.iHttpPort = h.iPort, a = h.iPort)) : (Z("RTSP RealPlay"), o = f.oProtocolInc.CGI.startRealPlay, i = "rtsp://", d = h.iStreamType, u = h.iChannelID, W(h.iPort) || (f.iRtspPort = h.iPort), -1 == f.iRtspPort && (f.iRtspPort = B(f).iRtspPort), a = f.iRtspPort), -1 == a) return Z("获取端口号失败"),
                                r;
							/*console.log(I.extend(h, {
                                    urlProtocol: i,
                                    cgi: o,
                                    iPort: a,
                                    iStreamType: d,
                                    iChannelID: u
                                }), n = this.findWndIndexByIndex(h.iWndIndex), -1 == n && (r = f.oProtocolInc.startRealPlay(f, h)), -1 == r));*/
                        ...
                        if (I.browser().msie) try {
                            new ActiveXObject("WebVideoKitActiveX.WebVideoKitActiveXCtrl.1"),
                                e = !0
                                                    ...
                                                    n = navigator.mimeTypes.length; n > s; s++) if ("application/webvideo-plugin-kit" == navigator.mimeTypes[s].type.toLowerCase()) {
                            e = !0;
                            break
                        }
                        return e ? 0 : -1
                ...
                st.prototype.CGI = {
                    ...
                    st.prototype.startRealPlay = function(e, t) {
						...
						var szIP = e.szIP;
						if(szIP.indexOf(":")>0){
							szIP=szIP.substr(0,szIP.indexOf(":"));
						}
						//n = t.bZeroChannel ? k(t.cgi.zeroChannels, t.urlProtocol, e.szIP, t.iPort, s) : k(t.cgi.channels, t.urlProtocol, e.szIP, t.iPort, s);
                        
                        n = t.bZeroChannel ? k(t.cgi.zeroChannels, t.urlProtocol, szIP, t.iPort, s) : k(t.cgi.channels, t.urlProtocol, szIP, t.iPort, s);
                        var r = u.HWP_Play(n, e.szAuth, t.iWndIndex, "", "");
                        if (0 == r) {
                            var o = new Q;
                            o.iIndex = t.iWndIndex,
                    ...
                    st.prototype.startPlayback = function(e, t) {								
                        ...
                        var s = t.iWndIndex,
                            n = t.szStartTime,
                            r = t.szEndTime,
                            o = k(t.cgi, t.urlProtocol, szIP, t.iPort, t.iChannelID, n, r),
